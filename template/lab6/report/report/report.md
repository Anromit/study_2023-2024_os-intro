...
В рабочем пространстве разместим и соединим устройства в соответствии с топологией, приведённой в лабораторной работе. Для подсети IPv4 используем маршрутизатор FRR, а для подсети с IPv6 — маршрутизатор VyOS. После чего изменим отображаемые названия устройств. Коммутаторам присвоим названия по принципу msk-arromichina-sw-0x, маршрутизаторам — по принципу msk-arromichina-gw-0x, VPCS — по принципу PCx-arromichina, где вместо x — порядковый номер устройства (рис. [-@fig:002]).

![Размещение и соединение устройств в соответствии с топологией, приведённой в лабораторной работе. Присвоение новых названий устройствам.](image/2.png){#fig:002 width=70%}
...
Настроим IPv4-адресацию для интерфейсов узлов PC1-arromichina(рис. [-@fig:004]).

![Настройка IPv4-адресации для интерфейса узла PC1-arromichina.](image/4.png){#fig:004 width=70%}

Настроим IPv4-адресацию для интерфейсов узлов PC2-arromichina (рис. [-@fig:005]).

![Настройка IPv4-адресации для интерфейса узла PC2-arromichina.](image/5.png){#fig:005 width=70%}

Настроим IPv4-адресацию для интерфейсов узлов Server-arromichina (рис. [-@fig:006]).

![Настройка IPv4-адресации для интерфейса узла Server-arromichina.](image/6.png){#fig:006 width=70%}

Посмотрим на PC1-arromichina конфигурацию IPv4 и IPv6 (рис. [-@fig:007]).

![Просмотр на PC1-arromichina конфигурации IPv4 и IPv6.](image/7.png){#fig:007 width=70%}

Посмотрим на PC2-arromichina конфигурацию IPv4 и IPv6(рис. [-@fig:008]).

![Просмотр на PC2-arromichina конфигурации IPv4 и IPv6.](image/8.png){#fig:008 width=70%}

Теперь настроим IPv4-адресацию для интерфейсов локальной сети маршрутизатора FRR msk-arromichina-gw-01 (рис. [-@fig:009]).

![Настройка IPv4-адресации для интерфейсов локальной сети маршрутизатора FRR msk-arromichina-gw-01.](image/9.png){#fig:009 width=70%}

Проверим конфигурацию маршрутизатора и настройки IPv4-адресации (рис. [-@fig:010]).

![Проверка конфигурации маршрутизатора и настройки IPv4-адресации.](image/10.png){#fig:010 width=70%}

Проверим подключение с помощью команд ping и trace. Узлы PC1-arromichina и PC2-arromichina успешно отправляют эхо-запросы друг другу и на сервер с двойным стеком (Dual Stack Server)(рис. [-@fig:011]).

![Проверка подключения с помощью команд ping и trace на PC1-arromichina и на PC2-arromichina.](image/11.png){#fig:011 width=70%}

Настроим IPv6-адресации для интерфейса узла PC3-arromichina.(рис. [-@fig:012]).

![Настройка IPv6-адресации для интерфейса узла PC3-arromichina.](image/12.png){#fig:012 width=70%}

Настроим IPv6-адресации для интерфейса узла PC4-arromichina. (рис. [-@fig:013]).

![Настройка IPv6-адресации для интерфейса узла PC4-arromichina.](image/13.png){#fig:013 width=70%}

Настроим IPv6-адресации для интерфейса узла Server-arromichina.(рис. [-@fig:014]).

![Настройка IPv6-адресации для интерфейса узла Server-arromichina.](image/14.png){#fig:014 width=70%}

Посмотрим на PC3-arromichina конфигурации IPv4 и IPv6.(рис. [-@fig:015]).

![Просмотр на PC3-arromichina конфигурации IPv4 и IPv6.](image/15.png){#fig:015 width=70%}

Посмотрим на PC4-arromichina конфигурации IPv4 и IPv6.(рис. [-@fig:016]).

![Просмотр на PC4-arromichina конфигурации IPv4 и IPv6.](image/16.png){#fig:016 width=70%}

Настроим IPv6-адресацию для интерфейсов локальной сети маршрутизатора VyOS msk-arromichina-gw-02. Перейдём в режим конфигурирования, изменим имя устройства(рис. [-@fig:017]).

![Настройка IPv6-адресации для интерфейсов локальной сети маршрутизатора VyOS msk-arromichina-gw-02. Переход в режим конфигурирования, изменение имени устройства.](image/17.png){#fig:017 width=70%}

Назначим IPv6-адреса маршрутизатору msk-arromichina-gw-02 (рис. [-@fig:018]).

![Назначение IPv6-адресов маршрутизатору msk-arromichina-gw-02.](image/18.png){#fig:018 width=70%}

Посмотрим захваченный на соединении сервера двойного стека адресации с коммутатором трафик ARP, ICMP, ICMPv6(рис. [-@fig:019]).

![Посмотр захваченный на соединении сервера двойного стека адресации с коммутатором трафик ARP, ICMP, ICMPv6](image/19.png){#fig:019 width=70%}
