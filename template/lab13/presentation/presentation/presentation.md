...
- Переход на клиенте под пользователем arromichina в каталог /mnt/nfs/home/arromichina и попытка создать в нём файл arromichina@client.txt.

![](./image/30.png)

## Подключение каталогов для работы пользователей

- Переход на клиенте под пользователем root в каталог /mnt/nfs/home/arromichina и попытка создать в нём файл arromichina@client.txt.

![](./image/31.png)

## Подключение каталогов для работы пользователей

- Просмотр наличия изменений на сервере в каталоге пользователя /home/arromichina/common.
