...
На сервере под пользователем arromichina запустим графическую программу для просмотра журналов (рис. [-@fig:009]).

![Запуск на сервере под пользователем arromichina графической программы для просмотра журналов.](image/9.png){#fig:009 width=70%}
